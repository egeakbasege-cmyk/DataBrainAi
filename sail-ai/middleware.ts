...
export default auth((req: NextRequest & { auth?: any }) => {
  ...
  const csp = [
    ...
    "connect-src 'self' https://generativelanguage.googleapis.com https://api.stripe.com https://accounts.google.com https://oauth2.googleapis.com https://api.groq.com",
