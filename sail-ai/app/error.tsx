...
export default function ErrorPage({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center" style={{ background: '#FAFAF8' }}>
      ...
      <h1 style={{ fontFamily: 'var(--font-cormorant), Georgia, serif', fontStyle: 'italic', fontSize: 'clamp(1.5rem, 3vw, 2rem)', color: '#0C0C0E', marginBottom: '0.75rem' }}>
        Something went off course
      </h1>
      <p style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '0.875rem', color: '#71717A', maxWidth: '34ch', lineHeight: 1.7 }}>
