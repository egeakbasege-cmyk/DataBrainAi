              ...
              >
                {tier.accent && (
                  <>
                    ...
                    <img src="/sail-square.svg" alt="" aria-hidden="true" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.12, pointerEvents: 'none', borderRadius: 'inherit' }} />
                  </>
                )}
