...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (mode === 'register') {
      ...
      try {
        ...
        // API returns { message } (handleApiError format) or legacy { error }
  ...
  const inp: React.CSSProperties = {
    ...
    border:     'none',
    borderBottom: '1px solid rgba(12,12,14,0.15)',
    outline:    'none',
    ...
    <main style={{
      ...
      <div style={{
        ...
        {googleAvail && (
          <>
            ...
            <div style={{
              ...
              <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.72rem', color: '#A1A1AA', letterSpacing: '0.05em' }}>
                or
              </span>
              <div style={{ flex: 1, height: 1, background: 'rgba(12,12,14,0.09)' }} />
            </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          {mode === 'register' && (
            <div>
              <label style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.65rem', letterSpacing: '0.09em', textTransform: 'uppercase', color: '#A1A1AA' }}>
                Name
              </label>
              <input
                type="text"
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{ position: 'absolute', right: 0, bottom: '0.65rem', background: 'none', border: 'none', cursor: 'pointer', color: '#A1A1AA', padding: 0, lineHeight: 1 }}
              >
          ...
          <button
            ...
            style={{
              width:         '100%',
              padding:       '0.8125rem',
              background:    loading ? '#3A3A3C' : '#0C0C0E',
              color:         '#FAFAF8',
              border:        'none',
              cursor:        loading ? 'not-allowed' : 'pointer',
              fontFamily:    'Inter, sans-serif',
